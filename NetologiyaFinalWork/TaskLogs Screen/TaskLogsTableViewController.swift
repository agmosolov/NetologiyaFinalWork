...
class TaskLogsTableViewController: UITableViewController {
    ...
    // Меню обработки лога при тапе или левом свайпе
    ...
    // Вызывается когда надо в истории логов изменить статус задачи
    ...
    // Вызывается когда надо в истории логов изменить фактическое значение
    private func changeFactValue(for indexPath: IndexPath) {
    ...
    // Вызывается когда надо в истории логов изменить плановое значение
    private func changePlanValue(for indexPath: IndexPath) {
    ...
    // Вызывается при нажатии на кнопку сортировки по алфавиту на NavBar
    ...
    // Вызывается при нажатии на кнопку сортировки по дате и при загрузке экрана
    ...
    // Вызывается при нажатии кнопки удалить лог
    ...
    // Вызывается когда надо удалить лог
